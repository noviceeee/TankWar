...
public class TankClient extends Frame {//坦克客户端，为网络版做准备
	...
	Tank myTank = new Tank(100,100, true, this);//创建我方坦克对象，初始坐标（100，100），传入当前TankClient对象
	Tank enemyTank = new Tank(200,200, false, this);//创建敌方坦克对象，初始坐标（200，200），传入当前TankClient对象
